...
const m = new MeshLambertMaterial({ color: 0xffffff, map: new TextureLoader().load("./sindre.png") });
...
const url = new URLSearchParams(window.location.search).get("image") || "erna.png";
